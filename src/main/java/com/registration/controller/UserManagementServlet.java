...
import com.registration.DAO.UserManagementDAO;
...
public class UserManagementServlet extends HttpServlet {
    ...
    throws SQLException, IOException, ServletException {
        ...
        UserBean newUser = new UserBean(firstName, lastName, userName, null, email, telephone);
    ...
    throws SQLException, IOException {
        ...
        UserBean book = new UserBean(userid, firstName, lastName, userName, password, email, telephone, adminValue, activeValue);
