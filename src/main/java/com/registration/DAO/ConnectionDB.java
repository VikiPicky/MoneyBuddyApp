...
//	private Connection connection;
	...
	private void init() {
		...
		try {
			...
			String sql = "CREATE SCHEMA IF NOT EXISTS moneybuddy;";
	...
	public Connection getConnection() {
		try {
			...
			String USE_SCHEMA = "USE moneybuddy;";
			statement.executeUpdate(USE_SCHEMA);
			return connection;
